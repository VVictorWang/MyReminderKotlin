package com.victor.kotlintest.widget
...
class PickerView : View {
    ...
    fun getSelectData(): String = mDataList[mCurrentSelected]
    ...
    fun setSelected(selected: Int) {
        ...
        val distance = mDataList.size / 2 - mCurrentSelected //计算选中的和原来中间值的差值，判断是向上滑动还是向下滑动
        if (distance < 0)
        //向下滑动
    ...
    private fun drawData(canvas: Canvas) {
        ...
        val scale = parabola(mViewHeight / 4.0f, mMoveLen) //根据scale产生字体大小的渐变效果
